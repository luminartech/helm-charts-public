...
| `global.IAMRoleARN`                              | Default IAM role ARN for pod                                                     | `arn:aws:iam::AWS-ACCOUNT-ID:role/IAM-ROLE-NAME`      |
| `global.persistentDataDiskSize`                  | Persistent volume size for the pod                                               | `10Gi`                                                |
| `global.storageClassName`                        | Persistent volume claim class                                                    | `default`                                             |
| `global.dockerEnabled`                           | Enable docker in docker                                                          | `false`                                               |
...
| `global.env.SOURCE_DIR`                          | devspace sources dir                                                             | `sources`                                             |
...
| `global.resources.initContainer.requests.cpu`    | CPU requests                                                                     | `1`                                                   |
| `global.resources.initContainer.requests.memory` | Memory requests                                                                  | `512Mi`                                               |
| `global.resources.initContainer.limits.cpu`      | CPU limits                                                                       | `1`                                                   |
| `global.resources.initContainer.limits.memory`   | Memory limits                                                                    | `512Mi`                                               |
| `global.resources.devspace.requests.cpu`         | CPU requests                                                                     | `4`                                                   |
| `global.resources.devspace.requests.memory`      | Memory requests                                                                  | `4Gi`                                                 |
| `global.resources.devspace.limits.cpu`           | CPU limits                                                                       | `4`                                                   |
| `global.resources.devspace.limits.memory`        | Memory limits                                                                    | `4Gi`                                                 |
| `global.resources.dind.requests.cpu`             | CPU requests                                                                     | `4`                                                   |
| `global.resources.dind.requests.memory`          | Memory requests                                                                  | `4Gi`                                                 |
| `global.resources.dind.limits.cpu`               | CPU limits                                                                       | `4`                                                   |
| `global.resources.dind.limits.memory`            | Memory limits                                                                    | `4Gi`                                                 |
...
| `common-res.StatefulSet.items._.podSpec.spec.securityContext.runAsGroup`                             | Specify the default user group id                                                              | `1000`                                                                                         |
| `common-res.StatefulSet.items._.podSpec.spec.securityContext.runAsUser`                              | Specify the default user id                                                                    | `1000`                                                                                         |
...
| `common-res.StatefulSet.items._.podSpec.spec.containers[0].name`                                     |                                                                                                | `devspace`                                                                                     |
| `common-res.StatefulSet.items._.podSpec.spec.containers[0].image`                                    |                                                                                                | `{{ .Values.global.images.devcontainer }}`                                                     |
| `common-res.StatefulSet.items._.podSpec.spec.containers[0].imagePullPolicy`                          | Container image pullPolicy. Allowed values: `IfNotPresent`, `Always`, `Never`                  | `IfNotPresent`                                                                                 |
...
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].name`                                     |                                                                                                | `dind`                                                                                         |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].image`                                    |                                                                                                | `docker:dind-rootless@sha256:a5090d7c11c05a862ae22fbb478c62a4e9643fa431eaf7a9a7812fef7a67a859` |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].imagePullPolicy`                          | Container image pullPolicy. Allowed values: `IfNotPresent`, `Always`, `Never`                  | `IfNotPresent`                                                                                 |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].ports[0].name`                            | Name of the port                                                                               | `docker`                                                                                       |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].ports[0].containerPort`                   | The port number                                                                                | `2376`                                                                                         |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].ports[0].protocol`                        | Port protocol. Allowed values: "SCTP", `TCP` and `UDP`.                                        | `TCP`                                                                                          |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].securityContext.runAsGroup`               | Specify the default user group id                                                              | `0`                                                                                            |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].securityContext.runAsUser`                | Specify the default user id                                                                    | `0`                                                                                            |
| `common-res.StatefulSet.items._.podSpec.spec.containers[1].securityContext.privileged`               | Privileged mode true or false. Allowed values: `true` or `false`                               | `true`                                                                                         |
